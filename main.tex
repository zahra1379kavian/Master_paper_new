...
\begin{figure}[!p]
    ...
    \caption{GVS-specific modulation of behaviour and network response features. \textbf{A}, Normalized reaction time by stimulation condition in OFF- and ON-medication sessions. The OFF-medication GVS7 effect that survived FDR correction is highlighted. \textbf{B}, Active-minus-sham late-minus-early response feature for the vigour-network projection in OFF- and ON-medication sessions. \textbf{C}, Corresponding late-minus-early response feature for the task-activation network signal. Highlighted distributions mark stimulation conditions that survived FDR correction within the displayed analysis.}
