...
\begin{abstract}
\section{}
In motor tasks with repetitive trials, motor vigour varies substantially from trial to trial in people with Parkinson’s disease (PD). A key question is whether this behavioural variability reflects an unstable central vigour-related central command, or whether a relatively stable neural command becomes more variable downstream as it is translated into movement. The existence of a vigour-related network could provide a candidate target for brain stimulation rather than relying on noisy behavioural trials. To examine this, we analysed individual trial fMRI data from 18 participants with PD who performed an overlearned, ballistic hand-squeeze task in OFF- and ON-medication sessions during subthreshold galvanic vestibular stimulation (GVS) with different stimuli. Single-trial fMRI responses were estimated using GLMsingle and entered into a constrained optimisation framework designed to identify a network that was jointly active during the task, encoded behaviour, and showed low variability in its activity over trials. This procedure identified a “vigour network” whose activity remained overall related to behavioural vigour but changed less abruptly than behaviour itself. This pattern is consistent with the possible presence of a relatively stable central vigour-related network in PD. Anatomically, the vigour network included motor, striatal, cerebellar, thalamic, parietal, temporal-limbic, and orbitofrontal regions. Its limited overlap with the simultaneously-computed task-activation map suggested that vigour-related information was not simply a sub-network of general task activation. Dopaminergic medication strengthened local connectivity within the network. Exploratory GVS analyses further showed that the  stimulation waveforms associated with faster responses was mirrored by changes the vigour-network activity, and this was not seen in the broader task-activation network. GVS also altered functional connectivity in both networks, but the pattern of connectivity changes in the vigour network was distinct from that seen in the task-activation map. Together, these findings suggest that movement variability in PD may arise partly when a relatively stable vigour-related signal is subsequently translated downstream into movement. The upstream network identified in this study may therefore provide a viable target for neuromodulation therapies designed to increase motor vigour in people with Parkinson’s disease (PD).
...
The projected time courses provided an initial indication that GVS affected the vigour-network signal in a stimulus-specific manner. Across GVS conditions, the projected vigour-network signal showed a similar waveform and medication-specific pattern (Supplementary Figure~S13A). For the late-minus-early response feature, GVS7 was the only active condition that differed from sham in the OFF-medication session (Figure~\ref{fig:gvs_behaviour_network_responses}B). The active-minus-sham difference was negative, indicating that GVS7 reduced the late relative to the early component of the projected vigour-network response. This effect was absent during the ON-medication session, in which no active GVS condition survived correction. The full vigour-network feature summaries are shown in Supplementary Figure~S15A,B.
...
% This study has several limitations. We included only participants with PD, so we cannot say if the vigour network would also be seen in healthy controls. Vigour was indexed mainly by reaction time, which captures response initiation; however, other components such as movement speed, force amplitude, force rise time, and movement duration are also important aspects of vigour and may dissociate depending on task demands \citep{pierrieau2025changes}. Causal interpretation is also limited by the fixed OFF-then-ON medication order (necessitated for safety and comfort of the participants), which may confound medication effects with practice, fatigue, time-on-task, or scanner drift. In addition, reward cues, GVS stimulus, block context, and adaptation across the run may have contributed to both RT and trial-wise neural activity, not just the vigour network. A related methodological caveat is that BOLD variability can include non-neural vascular contributions; scaling with resting-state fluctuation amplitude or breath-hold responses can reduce this variability, especially in block-design motor fMRI \citep{kannurpatti2011non}. Finally, the optimisation was linear and was developed and characterised in the same dataset. Cross-validation and control analyses reduce this concern, but independent validation is needed in new PD cohorts, healthy adults, and different motor tasks. An argument could be made that our results are the result of a circular argument: low consecutive-trial variability was one optimisation criterion. However, the model was constrained not only by stability, but also by task engagement, behavioural relevance, and spatial coherence.  At the subject level, the optimised projection was less variable than RT. At the voxel level, the selected voxels were concentrated among low-variability voxels and showed lower mean variability than size-matched samples from non-selected motor-area voxels. These validation analyses support the view that the solution was neither an arbitrary smooth sample of motor activity nor simply a restatement of behavioural variability.

This study has several limitations. We included only participants with PD, so we cannot say whether the vigour network would also be present in healthy controls. Vigour was indexed mainly by reaction time, which captures response initiation; other components such as movement speed, force amplitude, force rise time, and movement duration are also important aspects of vigour and may dissociate depending on task demands \citep{pierrieau2025changes}. Causal interpretation is limited by the fixed OFF-then-ON medication order (necessitated for participant safety and comfort), which may confound medication effects with practice, fatigue, time-on-task, or scanner drift. In addition, reward cues, GVS stimulus, block context, and adaptation across the run may have contributed to both RT and trial-wise neural activity, not just the vigour network. A related methodological caveat is that BOLD variability can include non-neural vascular contributions; scaling with resting-state fluctuation amplitude or breath-hold responses can reduce this variability, especially in block-design motor fMRI \citep{kannurpatti2011non}. Finally, the optimisation was linear and was developed and characterised in the same dataset; cross-validation and control analyses reduce this concern, but independent validation is still needed in new PD cohorts, healthy adults, and different motor tasks. A further concern is that our results could appear circular, because low consecutive-trial variability was itself one of the optimisation criteria. Several considerations argue against this. First, the network was shaped by several constraints acting together: task engagement, behavioural relevance, and spatial coherence, not by stability alone, so a smooth but behaviourally uninformative signal could not have satisfied the objective. Second, we directly tested the contribution of the stability term by re-running the same framework with the low-variability penalty removed; this control solution was more variable than the final network and contained fewer low-variability voxels (Supplementary Figure S4; Table S3), confirming that the penalty acted mainly to sharpen the low-variability tail of the selected-voxel distribution. Third, at the voxel level, the selected voxels were concentrated among low-variability voxels and showed lower mean variability than size-matched samples from non-selected motor-area voxels. Together, these analyses indicate that the solution was neither an arbitrary smooth sample of motor activity nor simply a restatement of behavioural variability.
