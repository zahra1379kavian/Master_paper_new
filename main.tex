...
\begin{abstract}
\section{}
In motor tasks with repetitive trials, movement vigour varies substantially from trial to trial in people with Parkinson’s disease (PD). It is unclear whether this trial-to-trial variability arises from an unstable central vigour-related command or from processes further downstream in the motor system. A distinct motor vigour network, if identified, may inform future target for neuromodulation.
...
Data supporting the results of this study are available at \url{https://borealisdata.ca/privateurl.xhtml?token=a2977151-accb-49cc-a812-2a770b5beeed}.
